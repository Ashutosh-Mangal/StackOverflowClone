...
export const deleteComment =
  ...
  async (dispatch) => {
    try {
      await api.deleteComment({ questionId, questionCommentId });
      // dispatch(fetchAllQuestions());
    } catch (error) {
      console.log(error);
    }
...
export const editComment =
  ({ questionId, questionCommentId, editedComment }) =>
  async (dispatch) => {
    try {
      await api.editComment({ questionId, questionCommentId, editedComment });
      // dispatch(fetchAllQuestions());
    } catch (error) {
      console.log(error);
    }
